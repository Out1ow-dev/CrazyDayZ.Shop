        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxSlots = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "INTEGER", nullable: false),
                    AvailableServers = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lotteries_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewPrice = table.Column<string>(type: "TEXT", nullable: false),
                    Discount = table.Column<string>(type: "TEXT", nullable: false),
                    ImageUrl = table.Column<string>(type: "TEXT", nullable: false),
                    AvailableServers = table.Column<string>(type: "TEXT", nullable: false),
                    CategoryId = table.Column<int>(type: "INTEGER", nullable: false),
                    ShowDiscount = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsAviable = table.Column<bool>(type: "INTEGER", nullable: false),
                    Order = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LotteryId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LotteryProduct", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LotteryProduct_Lotteries_LotteryId",
                        column: x => x.LotteryId,
                        principalTable: "Lotteries",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_LotteryProduct_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarAttachment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarAttachment_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lotteries_CategoryId",
                table: "Lotteries",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_LotteryProduct_LotteryId",
                table: "LotteryProduct",
                column: "LotteryId");

            migrationBuilder.CreateIndex(
                name: "IX_LotteryProduct_ProductId",
                table: "LotteryProduct",
                column: "ProductId");
